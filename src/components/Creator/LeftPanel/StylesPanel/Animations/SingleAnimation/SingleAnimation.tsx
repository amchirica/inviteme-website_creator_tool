                ...
                ? <>
                    <div className={styles.stylesFormRow}>
                        <div className={styles.stylesFormField}>
                            <InputWithUnits units={timeUnits} label="Duration" value={duration}
                                            onChange={changeDuration}
                                            min={0}/>
                        </div>
                        <div className={styles.stylesFormField}>
                            <InputWithUnits units={timeUnits} label="Start delay" value={delay}
                    ...
                    <div className={styles.stylesFormRow}>
                        <div className={styles.stylesFormField}>
                            <Select label="Number of iterations" onChange={changeIteration}>
                                <Option value="infinite" selected={iteration === 'infinite'}>Infinit</Option>
                        ...
                        <div className={styles.stylesFormField}>
                            ...
                            <Select label="Animation direction" onChange={changeDirection}>
                                <Option value="normal" selected={direction === 'normal'}>Forward</Option>
                                <Option value="reverse" selected={direction === 'reverse'}>Backwards</Option>
                                <Option value="alternate" selected={direction === 'alternate'}>Forward and forward so many</Option>
                                <Option value="alternate-reverse" selected={direction === 'alternate-reverse'}>Backwards and forwards</Option>
                            </Select>
                        </div>
                    </div>
                </> : ''}
