        ...
        <div className={styles.stylesFormGroup}>
            <div className={styles.stylesFormRow}>
                <div className={styles.stylesFormField}>
                    <InputWithUnits units={units} label="Top" value={marginTop}
                                    onChange={e => props.onChange(e, 'marginTop')}/>
                </div>
                <div className={styles.stylesFormField}>
                    <InputWithUnits units={units} label="Bottom" value={marginBottom}
                                    onChange={e => props.onChange(e, 'marginBottom')}/>
                </div>
            </div>
            <div className={styles.stylesFormRow}>
                <div className={styles.stylesFormField}>
                    <InputWithUnits units={units} label="Left" value={marginLeft}
                                    onChange={e => props.onChange(e, 'marginLeft')}/>
                </div>
                <div className={styles.stylesFormField}>
                    <InputWithUnits units={units} label="Right" value={marginRight}
