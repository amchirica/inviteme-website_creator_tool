        ...
        <div className={styles.stylesFormGroup}>
            <div className={styles.stylesFormRow}>
                <div className={styles.stylesFormField}>
                    <Input label="Number of columns" value={columnCount}
                           onChange={(e, v) => props.onChange(v, 'columnCount')}/>
                </div>
            </div>
            <div className={styles.stylesFormRow}>
                <div className={styles.stylesFormField}>
                    <InputWithUnits units={units} label="Column width" value={columnWidth}
                                    onChange={e => props.onChange(e, 'columnWidth')}/>
                </div>
            </div>
            <div className={styles.stylesFormRow}>
                <div className={styles.stylesFormField}>
                    <InputWithUnits units={units} label="Distance between columns" value={columnGap}
                                    onChange={e => props.onChange(e, 'columnGap')}/>
                </div>
            </div>
            <div className={styles.stylesFormRow}>
                <div className={styles.stylesFormField}>
                    <InputWithUnits units={borderUnits} label="Distributor"
