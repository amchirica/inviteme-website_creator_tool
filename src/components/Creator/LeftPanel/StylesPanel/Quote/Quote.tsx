        ...
        <div className={styles.stylesFormGroup}>
            <div className={styles.stylesFormRow}>
                <div className={styles.stylesFormField}>
                    <Input type="text" value={leftChar} ref={leftInputRef} label="Sign on the left" onChange={changed}/>
                </div>
                <div className={styles.stylesFormField}>
                    <Input type="text" value={rightChar} ref={rightInputRef} label="Sign on the right" onChange={changed}/>
                </div>
            </div>
        </div>
    )
