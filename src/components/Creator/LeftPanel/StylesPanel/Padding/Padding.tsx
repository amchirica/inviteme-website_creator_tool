        ...
        <div className={styles.stylesFormGroup}>
            <div className={styles.stylesFormRow}>
                <div className={styles.stylesFormField}>
                    <InputWithUnits units={units} label="Top" value={paddingTop}
                                    onChange={e => props.onChange(e, 'paddingTop')}/>
                </div>
                <div className={styles.stylesFormField}>
                    <InputWithUnits units={units} label="Bottom" value={paddingBottom}
                                    onChange={e => props.onChange(e, 'paddingBottom')}/>
                </div>
            </div>
            <div className={styles.stylesFormRow}>
                <div className={styles.stylesFormField}>
                    <InputWithUnits units={units} label="Left" value={paddingLeft}
                                    onChange={e => props.onChange(e, 'paddingLeft')}/>
                </div>
                <div className={styles.stylesFormField}>
                    <InputWithUnits units={units} label="Right" value={paddingRight}
