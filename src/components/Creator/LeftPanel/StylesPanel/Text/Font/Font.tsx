        ...
        <>
            <div className={styles.stylesFormRow}>
                <div className={styles.stylesFormField}>
                    <InputWithUnits units={units} label="Font size" value={fontSize}
                                    onChange={e => props.onChange(e, 'fontSize')}/>
                </div>
                <div className={styles.stylesFormField}>
                    <InputWithUnits units={units} label="Line height" value={lineHeight}
                                    onChange={e => props.onChange(e, 'lineHeight')}/>
                </div>
            </div>
            <div className={styles.stylesFormRow}>
                <div className={styles.stylesFormField}>
                    <Select label="Font" onChange={e => props.onChange(e, 'fontFamily')}>
            ...
            <div className={styles.stylesFormRow}>
                <div className={styles.stylesFormField}>
                    <Select label="Font weight" onChange={e => props.onChange(e, 'fontWeight')}>
                        <Option value="" selected={!fontWeight}>Choose</Option>
