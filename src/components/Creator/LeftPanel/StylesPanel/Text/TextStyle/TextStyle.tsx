            ...
            {textDecorationLine.length
                ? <div className={styles.stylesFormRow}>
                    <div className={styles.stylesFormField}>
                        <InputWithUnits units={units} label="Line thickness" value={textDecorationThickness}
                                        onChange={e => props.onChange(e, 'textDecorationThickness')}/>
                    </div>
                    <div className={styles.stylesFormField}>
                        <Select onChange={e => props.onChange(e, 'textDecorationStyle')} label="Choose style">
                            {styleValues.map(val =>
